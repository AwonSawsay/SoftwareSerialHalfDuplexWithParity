/*
SoftwareSerialHalfDuplexWithParity.h (formerly SoftwareSerialHalfDuplexWithParity.h) - 
Multi-instance software serial with half duplex library for Arduino/Wiring

By default the library works the same as the SoftwareSerialHalfDuplexWithParity library, 
...
and help at this stage. Changes from SoftwareSerialHalfDuplexWithParity have been noted with a 
...
#ifndef SoftwareSerialHalfDuplexWithParity_h
#define SoftwareSerialHalfDuplexWithParity_h
...
class SoftwareSerialHalfDuplexWithParity : public Stream
{
private:
  // per object data
  uint8_t _receivePin;
  ...
  static SoftwareSerialHalfDuplexWithParity *active_object;
...
public:
  // public methods
  SoftwareSerialHalfDuplexWithParity(uint8_t receivePin, uint8_t transmitPin, bool inverse_logic = false, bool full_duplex = true);
  ~SoftwareSerialHalfDuplexWithParity();
